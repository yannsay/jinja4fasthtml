...
<a
href="https://github.com/yannsay/jinja4fasthtml/blob/main/jinja4fasthtml/core.py#L15"
target="_blank" style="float:right; font-size:smaller">source</a>

### parse_html_to_ft

>  parse_html_to_ft (html_str:str)
...
<a
href="https://github.com/yannsay/jinja4fasthtml/blob/main/jinja4fasthtml/core.py#L47"
target="_blank" style="float:right; font-size:smaller">source</a>

### add_template_from_code

>  add_template_from_code (templates_dict:dict[str], code:str, filename:str,
>                              env)
